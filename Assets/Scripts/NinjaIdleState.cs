...
public class NinjaIdleState : StateMachineBehaviour
{
    ...
    {
        animator.gameObject.GetComponentInChildren<SkinnedMeshRenderer>().enabled = true;
	...
	override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        animator.gameObject.GetComponentInChildren<SkinnedMeshRenderer>().enabled = false;
